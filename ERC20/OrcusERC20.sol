...
abstract contract OrcusERC20 is ERC20, OnlyBank, IOrcusERC20 {
    ...
    modifier onlyBurnable() {
        require(burnAddress[msg.sender], "OrcusERC20: Not burnable");
        _;
    }

    modifier onlyFarm() {
        require(farms[msg.sender], "OrcusERC20: Not farm");
        _;
    }
